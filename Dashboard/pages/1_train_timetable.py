...
# --- Optimiser ---
def consist_optimiser(long_train_df, train_meta_df=None, buffer_minutes=120, max_iter=50):
...
buffer_input = st.sidebar.slider("Train transit buffer (6 to 12 hours)", 120, 720,
